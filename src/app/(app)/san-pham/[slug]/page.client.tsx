...
export default function ProductDetailClient({ product }: { product: Product }) {
    ...
    const isOptionSelectedComplete = useMemo(() => {
        ...
        return product.options.every(
            (opt: any) => selectedOptions[opt.key],
        )
        ...
        <div className="container py-8">
                                ...
                                {opt.values.map((v: any) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`rounded-xl border-2 px-4 py-2 text-sm font-medium ${active
                    ...
                    <Tabs defaultValue={product.contentTabs[0].id || undefined}>
                        ...
                        >
                            {product.contentTabs.map((tab: any) => (
                                <TabsTrigger className="rounded-xl px-2 py-2 text-xs sm:px-6 sm:py-3 sm:text-sm font-semibold data-[state=active]:bg-background data-[state=active]:shadow-soft" key={tab.id} value={tab.id}>
                                    {tab.title}
                                </TabsTrigger>
                            ))}
                        </TabsList>
                        ...
                        {product.contentTabs.map((tab: any) => (
                            <TabsContent className="mt-6 rounded-2xl bg-card p-6 shadow-soft" key={tab.id} value={tab.id}>
            ...
            <div className="mt-12">
                <div className="mt-6 rounded-2xl bg-card p-6 shadow-soft">
                    <h2 className="mb-4 text-lg font-bold lg:text-2xl">

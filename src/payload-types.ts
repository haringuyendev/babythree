...
export interface Config {
  ...
  collectionsSelect: {
    ...
    shippings: ShippingsSelect<false> | ShippingsSelect<true>;
...
export interface Cart {
  ...
  items?:
    | {
        ...
        quantity: number;
        /**
         * Giá tại thời điểm thêm vào giỏ (tham khảo)
         */
        price: number;
        id?: string | null;
      }[]
...
export interface Product {
  ...
  options?:
    ...
    | null;
  /**
   * Giá & tồn kho theo từng phiên bản
   */
  variants?: {
    docs?: (string | Variant)[];
    hasNextPage?: boolean;
...
export interface Shipping {
  ...
  status: 'pending' | 'preparing' | 'shipping' | 'delivered' | 'failed';
  timeline: {
    status: string;
    description: string;
    createdAt?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "shippings_select".
 */
export interface ShippingsSelect<T extends boolean = true> {
  order?: T;
  carrier?: T;
  trackingCode?: T;
  status?: T;
